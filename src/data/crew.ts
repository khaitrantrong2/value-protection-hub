...
export const crew: CrewMember[] = [
  ...
  {
    name: "Thành",
    roleShort: "PH · ID GUARDIAN",
    role: "Value Protector",
    station: "PH & ID Twin Sector",
    market: "PH & ID",
    accent: "#38BDF8",
    clearance: "GAMMA-2X",
    rank: "guardian",
    blurb: "Guards the twin sector of the Philippines and Indonesia — retrieving value across two markets at once.",
  },
  {
    name: "Phương",
    roleShort: "CADET",
